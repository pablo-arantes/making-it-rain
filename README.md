...
```diff
- 31Mar2025: The AlphaFold2+MD notebook is not working, we are trying to fix the issue.
...
16. **Biomolecular Emulator+HPACKER** [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/pablo-arantes/making-it-rain/blob/main/BioEmu_HPACKER.ipynb) - `Biomolecular Emulator (BioEmu), a model that samples from the approximated equilibrium distribution of structures for a protein monomer, given its amino acid sequence and side-chain reconstruction, using HPacker.`
